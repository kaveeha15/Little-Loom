      ...
      <div className="orderForm">
        ...
        <div className="billingDetails">
          ...
          <div className="inline">
            <div>
              <input type="text" name="fName" placeholder="First name*" onChange={handleChange} className={errors.fName ? "error" : ""}/>
              {errors.fName && <span className="error-text">First name is required</span>}
            </div>
            <div>
              <input type="text" name="lName" placeholder="Last name*" onChange={handleChange} className={errors.lName ? "error" : ""}/>
          ...
          <div className="inline">
            <div>
              <input type="text" name="city" placeholder="Town/City*" onChange={handleChange} className={errors.city ? "error" : ""} />
              {errors.city && <span className="error-text">City is required</span>}
            </div>
            <div>
              <input type="text" name="pCode" placeholder="Postcode/ZIP*"onChange={handleChange}className={errors.pCode ? "error" : ""} />
              {errors.pCode && <span className="error-text">Postcode is required</span>}
            </div>
          </div>

          <div>
            <input type="text" name="pNo" placeholder="Phone*" onChange={handleChange} className={errors.pNo ? "error" : ""} />
            {errors.pNo && <span className="error-text">Phone number is required</span>}
          </div>

          <div>
            <input  type="text" name="email" placeholder="Email address*" onChange={handleChange} className={errors.email ? "error" : ""} />
